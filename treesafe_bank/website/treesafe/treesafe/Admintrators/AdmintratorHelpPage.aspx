...
CodeBehind="AdmintratorHelpPage.aspx.cs" Inherits="treesafe.Admintrators.AdmintratorHelpPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p class="header" style="font-size: medium; color: #FFFFFF;">
        ...
        <p>
        &nbsp;&nbsp;
        获取更详细的信息请点击：<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Admintrators/AdmintratorSystemIntro.aspx">这里</asp:HyperLink>
    </p>
        <p class="header" style="font-size: medium; color: #FFFFFF;">
        使用说明</p>
    ...
    <p style="color: #3366FF;">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
       管理员，您必须登陆本系统才可以使用本在线服务系统。
        <br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        当您登陆本系统之后，您可以通过本系统管理使用本系统的雇员情况，
       您可以为新的雇员分配新的账号，也可以删除旧雇员在本系统中的账号。
       除此之外，您还可以完成更为重要的工作：根据本行政策设置对小组进行风险评估的权重。
        </p>
    <p style="color: #3366FF;">
        &nbsp;</p>
</asp:Content>
