...
CodeBehind="AuditorHelpPage.aspx.cs" Inherits="treesafe.Auditors.AuditorHelpPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p class="header" style="font-size: medium; color: #FFFFFF;">
        ...
        <p>
        &nbsp;&nbsp;
        获取更详细的信息请点击：<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Auditors/AuditoSystemIntro.aspx">这里</asp:HyperLink>
    </p>
        <p class="header" style="font-size: medium; color: #FFFFFF;">
        使用说明</p>
    ...
    <p style="color: #3366FF;">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        审核员，您必须登陆本系统才可以使用本在线服务系统。
        <br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        当您登陆本系统之后，本系统会以列表形式出需要您审核其真实性的申请人信息。
        您需要经过实地走访探察等过程考察其信息真实性。当您完成审核之后同样需要登陆本系统，反馈审核结果。
        <br/>
        <br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        您的工作至关重要！
