...
{
	DEBUG_IS_HAS_SCORE_PRINT("is_user_has_score_get_data\n");
...
DEBUG_IS_HAS_SCORE_PRINT("is_user_has_score_convert_rlt\n");
...
void is_user_has_score_frame(const char* _cmd , int _cmd_len
	,char* _rlt,int* _rlt_len){
DEBUG_IS_HAS_SCORE_PRINT("is_user_has_score_frame\n");
		//初始化
